export const CSSIcon = ({ height, width, firstPath, secondPath, thirdPath }) => {
    return (
        <svg
            fill='none'
            height={height}
            ...
            <path d='M10.383 126.892L0 0l124 .255-10.979 126.637-50.553 14.638z' fill={firstPath} />
            <path d='M62.468 129.275V12.085l51.064.17-9.106 104.85z' fill={secondPath} />
            <path
