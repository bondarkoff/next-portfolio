...
import { SkillsContentLoader } from './SkillsContentLoader';
            ...
            <div className={styles['skills__wrapper']}>
                {loading ? (
                    ...
                    <div
                        ...
                        <p className={styles['skills__card-descr']}>
                            ...
                            fifth version will allow me to create a more SEO-optimized structure of
                            your product
                        </p>
                    </div>
                )}
                {loading ? (
                    ...
                    <div
                        ...
                        <p className={styles['skills__card-descr']}>
                            This style language allows me to create absolutely any look for your
